...
# Form implementation generated from reading ui file '..\LB2\ui\patient.ui'
#
...
class Ui_Patient(object):
    ...
    def retranslateUi(self, Patient):
        ...
        self.buttonDelete.setText(_translate("Patient", "Удалить"))
        self.buttonChange.setText(_translate("Patient", "Изменить"))
        self.buttonAdd.setText(_translate("Patient", "Добавить"))
        self.label_2.setText(_translate("Patient", "Телефон"))
        self.label_3.setText(_translate("Patient", "День рождение"))
        self.label.setText(_translate("Patient", "Имя"))
